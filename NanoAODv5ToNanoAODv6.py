...
"""
parser = argparse.ArgumentParser(description="python NanoAODv5ToNanoAODv6.py -rc wmLHEGS -pwg EXO -year 2018")
...
if len(sys.argv) <= 1:
  print('Usage: python NanoAODv5ToNanoAODv6.py -h')
  exit(1)
...
PRIORITY_BLOCK = 1
TICKET_NOTE = 'NanoAODv6 submission: Request scanning based on ' + campaign_name 
...
if(campaigntochain == 'wmLHEGS'):
  if (args.year == '2018'): 
    dchain = 'chain_RunIIFall18wmLHEGS_flowRunIIAutumn18DRPremix_flowRunIIAutumn18MiniAOD_flowRunIIAutumn18NanoAODv6'
    ...
    dchain = 'chain_RunIIFall17wmLHEGS_flowRunIIFall17DRPremixPU2017_flowRunIIFall17MiniAODv2_flowRunIIFall17NanoAODv6'
  ...
  if (args.year == '2018'): 
    dchain = 'chain_RunIIFall18GS_flowRunIIAutumn18DRPremix_flowRunIIAutumn18MiniAOD_flowRunIIAutumn18NanoAODv6'
    member_of_chain = 'chain_RunIIFall18GS_flowRunIIAutumn18DRPremix*'
  
  elif (args.year == '2017'): 
    dchain = 'chain_RunIIFall17GS_flowRunIIFall17DRPremixPU2017_flowRunIIFall17MiniAODv2_flowRunIIFall17NanoAODv6'
  ...
  if (args.year == '2018'): 
    dchain = 'chain_RunIIFall18pLHE_flowRunIIFall18GS_flowRunIIAutumn18DRPremix_flowRunIIAutumn18MiniAOD_flowRunIIAutumn18NanoAODv6'
    member_of_chain = '*RunIIFall18pLHE_flowRunIIFall18GS_flowRunIIAutumn18DRPremix*'
  
  elif (args.year == '2017'): 
    dchain = 'chain_RunIIFall17pLHE_flowRunIIFall17pLHE2GS_flowRunIIFall17DRPremixPU2017_flowRunIIFall17MiniAODv2_flowRunIIFall17NanoAODv6'
...
#                    do_chain = True
                    ...
                    for chained_request_for_root in chained_requests_for_root:
                        if('NanoAODv6' in chained_request_for_root['prepid']):
                            do_chain=False
